    ...
    public function rules()
    {
        return [
            ...
            [
                ...
                'number',
                'min' => 1,
                'max' => $this->fromModel->coin,
                'tooSmall' => 'Transfer amount cannot be less than 1',
                'tooBig' => 'Transfer amount cannot exceed the amount of coin in your account'
            ]
        ];
    }
    ...
    public function save()
    {
        ...
        try {
            if ($this->validate()) {
                ...
                $fromWallet->coin -= $this->toTransfer;
                if (!$fromWallet->save()) {
                ...
                ActivityLog::addEntry(
                    ActivityLog::EVENT_TRANSFER_COIN,
                    $this->fromModel->c_id,
                    [
                    ...
                    trim($this->fromModel->c_id).' transferred '.$this->toTransfer.' coin to '.trim($this->toModel->c_id)
                );
                return true;
            }
            $transaction->rollBack();
