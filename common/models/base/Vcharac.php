...
/**
 * This is the base-model class for table "vcharac".
 *
 ...
 */
abstract class Vcharac extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\VcharacQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\VcharacQuery(get_called_class());
    }
