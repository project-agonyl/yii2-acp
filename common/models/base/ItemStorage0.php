...
/**
 * This is the base-model class for table "ItemStorage0".
 *
 ...
 */
abstract class ItemStorage0 extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\ItemStorage0Query the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\ItemStorage0Query(get_called_class());
    }
